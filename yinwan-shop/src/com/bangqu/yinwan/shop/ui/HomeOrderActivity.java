...
public class HomeOrderActivity extends UIBaseActivity implements OnClickListener {
	...
	public void findView() {
		...
		Intent intent = new Intent(HomeOrderActivity.this, DingDanOne.class);
		list.add(getView("A", intent));
		Intent intent2 = new Intent(HomeOrderActivity.this, DingDanTwo.class);
		...
		yy = new MyOnPageChangeListener(this.activeBar, this.offset, this.imageWidth);
		yy.onPageSelected(str);
		yy.onPageScrolled(str, 0, 0);
		vpMyCollect.setOnPageChangeListener(yy);
		vpMyCollect.setCurrentItem(str);
		vpMyCollect.setOnPageChangeListener(new MyOnPageChangeListener(this.activeBar, this.offset,
				this.imageWidth));
	}
