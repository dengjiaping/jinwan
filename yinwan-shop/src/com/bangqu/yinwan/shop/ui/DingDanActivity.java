...
public class DingDanActivity extends UIBaseActivity implements OnClickListener {
	...
	private TextView tvMyCollectThree;
	private TextView tvMyCollectFour;
	...
	protected void onResume() {
		...
		if (vpMyCollect != null) {
			...
			case 0:
				...
				if (_activity != null && _activity instanceof DingDanOne) {
					((DingDanOne) _activity).onMyResume();
				}

				break;
			case 1:
				Activity _activity1 = manager.getActivity("B");
				if (_activity1 != null && _activity1 instanceof DingDanTwo) {
					((DingDanTwo) _activity1).onMyResume();
				}
				break;
			case 2:
				Activity _activity2 = manager.getActivity("C");
				if (_activity2 != null && _activity2 instanceof DingDanThree) {
					((DingDanThree) _activity2).onMyResume();
				}

				break;
			case 3:
				Activity _activity3 = manager.getActivity("D");
				if (_activity3 != null && _activity3 instanceof DingDanFour) {
					((DingDanFour) _activity3).onMyResume();
				}
	...
	public void findView() {
		...
		// 计算出偏移量
		this.offset = (screenWidth / 4 - imageWidth) / 2;
		// 设置图片初始值
		...
		Intent intent = new Intent(DingDanActivity.this, DingDanOne.class);
		list.add(getView("A", intent));
		Intent intent2 = new Intent(DingDanActivity.this, DingDanTwo.class);
