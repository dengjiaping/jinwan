...
public class GrouponManageActivity extends UIBaseActivity implements
		OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.home_groupon_layout);
	...
	protected void onResume() {
		...
		if (vpMyCollect != null) {
			...
			case 0:
				...
				Activity _activity3 = manager.getActivity("B");
				if (_activity != null
						&& _activity instanceof ProductIsGrouponActivity) {
					((ProductIsGrouponActivity) _activity).onMyResume();
				}

				if (_activity3 != null
						&& _activity3 instanceof ProductUnGrouponActivity) {
					((ProductUnGrouponActivity) _activity3).onMyResume();
				}
				break;

			case 1:
				Activity _activity1 = manager.getActivity("B");
				Activity _activity2 = manager.getActivity("A");
				if (_activity2 != null
						&& _activity2 instanceof ProductIsGrouponActivity) {
					((ProductIsGrouponActivity) _activity2).onMyResume();
				}
				if (_activity1 != null
						&& _activity1 instanceof ProductUnGrouponActivity) {
					((ProductUnGrouponActivity) _activity1).onMyResume();
				}
				break;
	...
	public void findView() {
		...
		Intent intent = new Intent(GrouponManageActivity.this,
				ProductIsGrouponActivity.class);
		list.add(getView("A", intent));
		Intent intent2 = new Intent(GrouponManageActivity.this,
				ProductUnGrouponActivity.class);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btnLeft:
			GrouponManageActivity.this.finish();
			break;
