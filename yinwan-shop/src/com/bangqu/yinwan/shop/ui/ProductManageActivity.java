...
public class ProductManageActivity extends UIBaseActivity implements OnClickListener,
	...
	private void findview() {
		...
		// tvTittle2.setOnClickListener(this);
		...
		mylistAdapter = new MyListAdapter(ProductManageActivity.this);
	...
	private class MyListAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = LayoutInflater.from(mContext).inflate(R.layout.product_item_layout,
						null);
				viewHolder = new ViewHolder();

				viewHolder.tvProductNO = (TextView) convertView.findViewById(R.id.tvProductNO);
				viewHolder.tvProductName = (TextView) convertView.findViewById(R.id.tvProductName);
				viewHolder.ivProductImg = (ImageView) convertView.findViewById(R.id.ivProductImg);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		Intent itemintent = new Intent(ProductManageActivity.this, ProductManageActivity.class);
