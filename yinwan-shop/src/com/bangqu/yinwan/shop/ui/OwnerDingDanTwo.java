...
public class OwnerDingDanTwo extends UIBaseActivity implements OnClickListener,
	...
	public void findView() {
		...
		mylistAdapter = new MyListAdapter(OwnerDingDanTwo.this);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.btnLeft:
			OwnerDingDanTwo.this.finish();
			break;

		case R.id.btnRight:
			Intent intent = new Intent(OwnerDingDanTwo.this, DingDanOne.class);
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			viewHolder.btlijichuli.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent itemintent = new Intent(OwnerDingDanTwo.this,
	...
	class LoadOrderListTask extends AsyncTask<String, Void, JSONObject> {
		...
		protected JSONObject doInBackground(String... params) {
			...
			try {
				// 返回一个 JSONObject
				return new OwnerHelper().Ownerorder2(id, state, begin);
		...
		protected void onPostExecute(JSONObject result) {
			...
			if (result != null) {
				try {
					...
					e.printStackTrace();
					Toast.makeText(OwnerDingDanTwo.this, "数据加载失败",
			...
			mHandler.postDelayed(new Runnable() {
				...
				public void run() {
					...
					new LoadOrderListTask(SharedPrefUtil
							.getOwnerID(OwnerDingDanTwo.this), "1", begin)
							.execute();
				}
			}, 1000);
			totalLinShi++;
