...
public class OwnerDingDanActivity extends UIBaseActivity implements
		OnClickListener {
	...
	protected void onResume() {
		...
		if (vpMyCollect != null) {
			...
			case 0:
				...
				if (_activity != null && _activity instanceof OwnerDingDanOne) {
					((OwnerDingDanOne) _activity).onMyResume();
				}
				break;
			case 1:
				Activity _activity1 = manager.getActivity("B");
				if (_activity1 != null && _activity1 instanceof OwnerDingDanTwo) {
					((OwnerDingDanTwo) _activity1).onMyResume();
				}
				break;
			default:
				break;
	...
	public void findView() {
		...
		Intent intent = new Intent(OwnerDingDanActivity.this,
				OwnerDingDanOne.class);
		intent.putExtra("state", "");
		list.add(getView("A", intent));
		Intent intent2 = new Intent(OwnerDingDanActivity.this,
				OwnerDingDanTwo.class);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.btnLeft:
			OwnerDingDanActivity.this.finish();
			break;
