package com.bangqu.yinwan.shop.internet;
...
public class HttpClient implements java.io.Serializable {
	...
	public Response multPartURL(String url, PostParameter[] params,
			ImageItem item) throws SystemException {
	...
	public Response multPartURL(String fileParamName, String url,
			PostParameter[] params, File file) throws SystemException {
		PostMethod post = new PostMethod(url);
		org.apache.commons.httpclient.HttpClient client = new org.apache.commons.httpclient.HttpClient();
		try {
			long t = System.currentTimeMillis();
	...
	public Response httpRequest(String url, PostParameter[] postParams,
			String httpMethod) throws SystemException {
		int retriedCount;
	...
	public static String encodeParameters(PostParameter[] postParams) {
		...
		for (int j = 0; j < postParams.length; j++) {
			...
			try {
				...
				System.out.println("aslijdflsajdf");
			}
		}
		return buf.toString();
